...
<style>
 ...
 <!-- BEGIN CONTENT -->
                                 ...
                                 <form class="form-horizontal"  id="submit_form"  >
                                           ...
                                           <div class="tab-pane" id="tab3">
                                               ...
                                               <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 ">3. Are you holding the property on behalf of a foreign resident or on behalf of other entities that includea foreign resident?
													<span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="form-actions">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            ...
                                                            <button  class="btn green button-submit repaypal"> Submit</button>
                                                                <i class="fa fa-check"></i>
                                                          
                                                        </div>
														 </div>
														  <div class="row ">
														 <div class="col-md-offset-6 col-md-6 pay"   style="display:none;">
        ...
        <div class="quick-nav-overlay"></div>
           ...
           <script>
            ...
            paypal.Button.render({
             ...
             client: {
              sandbox:    'AVRV4OeLs31jQuesijL5GALfc4_Tnc19qIXK_UuJGJdT67uPS0ERVpM2aZEBpdr0OTah2JvDJMEjeiu_',
              production: 'AQKTqb6U3cq6tJ1jvvXjg5HS0axRA3vCk-t2h0rjYcquvqVP-XB_cAbiGMKtUzVD7ulbV2PPOOK4zNpT'
             },
             ...
             payment: function(data, actions) {
              return actions.payment.create({
               payment: {  transactions: [ { amount: { total: '1.00', currency: 'USD' } } ] }
              });
             },
              ...
              success: function (tempdata) 
               {
                var values = JSON.parse(tempdata);
				 ...
				 $('#vendorinfo').html(values.message).show();
   ...
   <script type="text/javascript">
      $(".repaypal").click(function () {
	       $(".pay").trigger("click").show();
	  });
 ...
 <script type="text/javascript">
  function coutinueAction(){
    ...
    $.ajax({
        ...
        contentType:false,
        processData:false,
        url:'<?php echo site_url();?>/Dashboard_controller/foreignResidentAction',
        beforeSend:function(){
            $('.error').remove();
        },
  ...
  $('#submit_form').submit(function(e){
   ...
   var iscomplete=btoa(1);
    $.ajax({
        ...
        contentType:false,
        processData:false,
        url:'<?php echo site_url();?>/Dashboard_controller/foreignResidentAction/'+iscomplete,
        beforeSend:function(){
            $('.error').remove();
        },
        success:function(response){
