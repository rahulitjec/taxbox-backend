    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form id="maildata">
                ...
                <input type="hidden" name="fb_id" value="<?php echo $userdata['id'];?>" />
                <input type="hidden" name="name" value="<?php echo $userdata['name'];?>" />
                <div class="form-actions">
				 <a href="<?php echo base_url();?>" id="back-btn" class="btn grey-salsa btn-outline"> Back </a>
...
<![endif]-->
 ...
 <script type="text/javascript">
    ...
    e.preventDefault();
   var formdata=new FormData($('#maildata')[0]);
    ...
    $.ajax({
        ...
        contentType:false,
        processData:false,
        url:'<?php echo site_url();?>User_controller/socialview_action',
        beforeSend:function(){
            $('.error').remove();
            $('.loader').show();
        },
        success:function(response){
			...
			console.log(data);
            if(data.status == true){  
                $('#maildata').prepend('<p class="alert alert-success ">'+data.message+'</p>');
                      setTimeout(function(){
            ...
            $('#maildata').prepend('<p style="color:#e73d4a !important;" class="alert alert-danger error">'+data.message+'</p>');
