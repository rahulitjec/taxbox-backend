                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase">List Of Allocate Form To Another Subadmin</span>
                                        </div> 
		...
		function(){
		  $.ajax
			({ 
				...
				type: 'POST',
				async: true,
                url: '<?php echo base_url();?>Admin/allocateform_anothersubadmin_delete/'+ id, 
				processdata:false,
				cache: false,
