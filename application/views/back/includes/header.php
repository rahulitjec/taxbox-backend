...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url();?>assets/pages/datatables_checkbox/dataTables.checkboxes.css" rel="stylesheet" type="text/css" />
                        ...
                        <ul class="nav navbar-nav pull-right"> 
                         <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    ...
                                    <span class="username username-hide-on-mobile"><?php echo (!empty($this->session->userdata('adminname')))? $this->session->userdata('adminname') : '';?> </span>
