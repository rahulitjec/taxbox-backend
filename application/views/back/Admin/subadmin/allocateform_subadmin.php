                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase">Allocate Form To Subadmin</span>
                                        </div>
    ...
    $('#subadmin').submit(function(e){
      ...
      var form = this;
	   ...
	   $.ajax({
				...
				contentType:false,
				processData:false,
				url:'<?php echo site_url('Admin/allocateform_subadmin_action');?>',
				beforeSend:function(){
					$('.error').remove();	
				},
  ...
  function getVendor()
{
  ...
  var subadminId = $('#ddlSubAdmin').val();
     $.ajax({
                type:"POST", 
                contentType:false,
                processData:false,
                url:'<?php echo site_url();?>Admin/allocateform_subadmin_selected/'+subadminId,
                beforeSend:function(){
                    $('.error').remove();   
                },
                success:function(response){
