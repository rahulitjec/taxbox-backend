                                   ...
                                   <div class="tab-content col-md-8">
                                            ...
                                            <div class="portlet light bordered">
                                                ...
                                                <div class="portlet-body form"  style="margin-left:1%">
													 ...
													 <span class="" style="font-weight:400;margin-left:15%;">2.1.1.2 Where do you live in Australia? </span><br>
													  <div class="row">
                                                                <div class="col-md-8 " >
                                                                    <div class="form-group">
													   ...
													   <br>
													    ...
													    <div id="spouse">
													    <span class="" style="font-weight:400;margin-left:0%;">Where are your spouse and/or dependent children?</span><br>
														 <div class="row">
                                                                <div class="col-md-8 " >
                                                                    <div class="form-group">
						         ...
						         <div class="form-actions">
						                     <div class="row">
                                                        <div class="col-md-offset-1 col-md-2">
                                                          <button  class="btn green button-submit repaypals"> Update</button>
                                                        </div>
														<div class="col-md-offset-2 col-md-2">
                                                          <a href="<?php echo base_url();?>Admin/submittedforms_list" class="btn default pull-right">Cancel</a>
                                                        </div>
												 </div><br>
												  <div class="alert alert-success" style="display:none;width:50%" id="vendorinfo"></div>
